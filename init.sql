...
('Ramenez la coupe a la maison', 'Vegedream', 'https://open.spotify.com/track/45eY7Qi2PDUs8WJEhjGWdN'),
...
('Batiment', 'Niska', 'https://open.spotify.com/track/7FF6HRsQlc0CtfAbLmrEGX'),
('Burgers', 'Les Jones', 'https://open.spotify.com/track/6KuGgTwvTa7A5WEKubUD4g'),
('Cette annee-la', 'Claude Francois', 'https://open.spotify.com/track/3R4rbnUNQKpKo588EFOqTl'),
